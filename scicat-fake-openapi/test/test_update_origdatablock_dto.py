...
from scicat_fake_openapi.models.update_origdatablock_dto import UpdateOrigdatablockDto  # noqa: E501
...
class TestUpdateOrigdatablockDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = scicat_fake_openapi.models.update_origdatablock_dto.UpdateOrigdatablockDto()  # noqa: E501
        if include_optional :
            return UpdateOrigdatablockDto(
                ...
                size = 1.337, 
                data_file_list = [
                    scicat_fake_openapi.models.data_file.DataFile(
                        path = '0', 
                        size = 1.337, 
