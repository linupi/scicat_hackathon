...
from scicat_fake_openapi.api.user_identities_api import UserIdentitiesApi  # noqa: E501
...
class TestUserIdentitiesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = scicat_fake_openapi.api.user_identities_api.UserIdentitiesApi()  # noqa: E501
