...
from scicat_fake_openapi.api.published_data_api import PublishedDataApi  # noqa: E501
...
class TestPublishedDataApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = scicat_fake_openapi.api.published_data_api.PublishedDataApi()  # noqa: E501
