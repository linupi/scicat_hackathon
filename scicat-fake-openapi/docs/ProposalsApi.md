# scicat_fake_openapi.ProposalsApi
...
with scicat_fake_openapi.ApiClient(configuration) as api_client:
    ...
    api_instance = scicat_fake_openapi.ProposalsApi(api_client)
    create_proposal_dto = scicat_fake_openapi.CreateProposalDto() # CreateProposalDto | 
...
with scicat_fake_openapi.ApiClient(configuration) as api_client:
    ...
    api_instance = scicat_fake_openapi.ProposalsApi(api_client)
    id = 'id_example' # str | 
update_proposal_dto = scicat_fake_openapi.UpdateProposalDto() # UpdateProposalDto | 
