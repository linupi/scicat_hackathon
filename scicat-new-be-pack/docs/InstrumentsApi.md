# scicat_new_be_pack.InstrumentsApi
...
with scicat_new_be_pack.ApiClient(configuration) as api_client:
    ...
    api_instance = scicat_new_be_pack.InstrumentsApi(api_client)
    create_instrument_dto = scicat_new_be_pack.CreateInstrumentDto() # CreateInstrumentDto | 
...
with scicat_new_be_pack.ApiClient(configuration) as api_client:
    ...
    api_instance = scicat_new_be_pack.InstrumentsApi(api_client)
    id = 'id_example' # str | 
update_instrument_dto = scicat_new_be_pack.UpdateInstrumentDto() # UpdateInstrumentDto | 
